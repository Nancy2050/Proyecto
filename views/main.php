...
<td><button id="ex" type="submit" value="INICIAR SESION"><img src="<?php echo constant('URL');?>public/IMG/empresa.png"  height="30px" width="30px"/><a href="<?php echo constant('URL');?>inicio_establecimiento">  INICIAR SESION</a></button></td>
 </tr> 
  <tr>    
