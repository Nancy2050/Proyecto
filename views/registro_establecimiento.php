...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    ...
    <title>REGISTRO ESTABLECIMIENTOS</title> <link rel="shortcut icon" href="public/IMG/icono.png"> 
...
<img  id="i" src="<?php echo constant('URL');?>public/IMG/icono.png" alt="icono food exe" />

    <!--Los datos del formulario son enviados a ingresar.php ahi se usan para almacenarlos en la base de datos-->
    <form action="<?php echo constant('URL');?>nuevo/registrarEstablecimiento" method="post" id="login" class="login">
    <h3  id="titulo">REGISTRO ESTABLECIMIENTO</h3>
